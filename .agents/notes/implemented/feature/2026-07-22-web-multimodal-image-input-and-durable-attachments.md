...
The [temporary container deployment](../architecture/2026-09-12-redis-session-context-and-temporary-attachments.md) explicitly opts out of byte retention and records relative paths plus missing-file surface replacements. The durable behavior described here remains the default.
