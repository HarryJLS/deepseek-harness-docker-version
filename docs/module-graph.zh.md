...
flowchart TD
  ...
  subgraph group_attachment["packages/attachment"]
    ...
    pkg_attachment_mysql["attachment-mysql"]
  end
  ...
  subgraph group_bundle["packages/bundle"]
    pkg_acp_app["acp-app"]
    pkg_base["base"]
    pkg_bundle_docker["bundle-docker"]
  ...
  subgraph group_nacos["packages/nacos"]
    pkg_credentials_nacos["credentials-nacos"]
    pkg_nacos_client["nacos-client"]
    pkg_nacos_file_mirror["nacos-file-mirror"]
    pkg_settings_nacos["settings-nacos"]
  end
  ...
  subgraph group_storage["packages/storage"]
    ...
    pkg_storage_mysql["storage-mysql"]
  ...
  pkg_mysql_schema --> pkg_user_context
  pkg_scope --> pkg_invariants
  pkg_web --> pkg_llm
  pkg_api_gateway --> pkg_user_context
  pkg_attachment --> pkg_brand
  pkg_client_connection --> pkg_user_context
  ...
  pkg_lsp --> pkg_brand
  pkg_lsp --> pkg_llm
  pkg_nacos_file_mirror --> pkg_nacos_client
  ...
  pkg_api_remotes --> pkg_user_context
  ...
  pkg_credentials_nacos --> pkg_credentials
  pkg_credentials_nacos --> pkg_nacos_client
  pkg_storage_mysql --> pkg_mysql_schema
  pkg_storage_mysql --> pkg_storage
  pkg_storage_mysql --> pkg_user_context
  ...
  pkg_settings_nacos --> pkg_nacos_client
  pkg_settings_nacos --> pkg_settings
  ...
  pkg_workspace --> pkg_user_context
  ...
  pkg_api_workspace_controller --> pkg_user_context
  pkg_api_workspace_controller --> pkg_workspace
  pkg_attachment_local --> pkg_agent
  pkg_attachment_local --> pkg_attachment
  pkg_attachment_local --> pkg_home_paths
  pkg_attachment_local --> pkg_llm
  pkg_attachment_local --> pkg_session
  pkg_attachment_local --> pkg_user_context
  ...
  pkg_attachment_mysql --> pkg_attachment
  pkg_attachment_mysql --> pkg_attachment_local
  pkg_attachment_mysql --> pkg_mysql_schema
  pkg_attachment_mysql --> pkg_user_context
  ...
  pkg_session_query --> pkg_user_context
  pkg_acp --> pkg_agent
  ...
  pkg_session_query_sqlite --> pkg_user_context
  ...
  pkg_api_session_controller --> pkg_user_context
...
| [`bundle-docker`](../packages/bundle/docker) | `bundle` | — |
...
| [`user-context`](../packages/identity/user-context) | `identity` | — |
| [`nacos-client`](../packages/nacos/nacos-client) | `nacos` | — |
...
| [`mysql-schema`](../packages/util/mysql-schema) | `util` | [`user-context`](../packages/identity/user-context) |
| [`scope`](../packages/core/scope) | `core` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`web`](../packages/web/web) | `web` | [`llm`](../packages/llm/llm) |
| [`api-gateway`](../packages/api/gateway) | `api` | [`user-context`](../packages/identity/user-context) |
| [`attachment`](../packages/attachment/attachment) | `attachment` | [`brand`](../packages/util/brand) |
| [`client-connection`](../packages/client/connection) | `client` | [`user-context`](../packages/identity/user-context) |
...
| [`nacos-file-mirror`](../packages/nacos/nacos-file-mirror) | `nacos` | [`nacos-client`](../packages/nacos/nacos-client) |
...
| [`session`](../packages/core/session) | `core` | [`scope`](../packages/core/scope), [`user-context`](../packages/identity/user-context) |
...
| [`api-remotes`](../packages/api/remotes) | `api` | [`scope`](../packages/core/scope), [`user-context`](../packages/identity/user-context) |
...
| [`credentials-nacos`](../packages/nacos/credentials-nacos) | `nacos` | [`credentials`](../packages/credentials/credentials), [`nacos-client`](../packages/nacos/nacos-client) |
| [`storage-mysql`](../packages/storage/storage-mysql) | `storage` | [`mysql-schema`](../packages/util/mysql-schema), [`storage`](../packages/storage/storage), [`user-context`](../packages/identity/user-context) |
...
| [`settings-nacos`](../packages/nacos/settings-nacos) | `nacos` | [`nacos-client`](../packages/nacos/nacos-client), [`settings`](../packages/settings/settings) |
...
| [`session-persistence-mysql`](../packages/session/session-persistence-mysql) | `session` | [`mysql-schema`](../packages/util/mysql-schema), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`user-context`](../packages/identity/user-context) |
...
| [`api-workspace-controller`](../packages/api/workspace-controller) | `api` | [`api-gateway`](../packages/api/gateway), [`client-connection`](../packages/client/connection), [`host-directory-picker`](../packages/host/directory-picker), [`session`](../packages/core/session), [`storage-domain`](../packages/storage/storage-domain), [`typert-protocol`](../packages/typert/protocol), [`user-context`](../packages/identity/user-context), [`workspace`](../packages/workspace/workspace) |
| [`attachment-local`](../packages/attachment/attachment-local) | `attachment` | [`agent`](../packages/core/agent), [`attachment`](../packages/attachment/attachment), [`home-paths`](../packages/util/home-paths), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`user-context`](../packages/identity/user-context) |
...
| [`attachment-mysql`](../packages/attachment/attachment-mysql) | `attachment` | [`attachment`](../packages/attachment/attachment), [`attachment-local`](../packages/attachment/attachment-local), [`mysql-schema`](../packages/util/mysql-schema), [`user-context`](../packages/identity/user-context) |
...
| [`user-questions`](../packages/interaction/user-questions) | `interaction` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`tools`](../packages/core/tools) |
...
| [`session-query`](../packages/session-query/session-query) | `session-query` | [`brand`](../packages/util/brand), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`session-projection-cache`](../packages/session/session-projection-cache), [`session-title`](../packages/session/session-title), [`tool-todo`](../packages/todo/tool-todo), [`user-context`](../packages/identity/user-context) |
...
| [`session-query-sqlite`](../packages/session-query/session-query-sqlite) | `session-query` | [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-query`](../packages/session-query/session-query), [`user-context`](../packages/identity/user-context) |
