...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'registerSharedStore(store: SharedFileUploadStore): () => void',
        description: 'Mount the single shared receipt provider for this Host.',
        parameters: [{ name: 'store', description: 'storage that authorizes every operation by Session ownership.' }],
      ...
      {
        signature: 'async resolveForRequest(agent: Agent, receiptId: FileUploadReceiptId): Promise<FileAttachmentRef | undefined>',
        description: 'Resolve an upload on any replica before synchronous prompt binding.',
        parameters: [{ name: 'agent', description: 'exclusively admitted receiving Agent.' }, { name: 'receiptId', description: 'staged receipt submitted with a prompt or command.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'registerSharedAssistantState(store: SharedAssistantStateStore): () => void',
        description: 'Install cross-replica Assistant state alongside shared Session persistence.',
        parameters: [{ name: 'store', description: 'reservation-bound transient stream storage.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Read the incremental question projection for the exact agent\'s session.',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  },
  {
    ...
    declaration: 'export type CommandFileReceiptResolver = (agent: Agent, receiptId: string) => FileAttachmentRef | undefined | Promise<FileAttachmentRef | undefined>;',
  },
  {
    name: 'CommandId',
  ...
  {
    name: 'FileUploadGeneration',
    declaration: 'export type FileUploadGeneration = Branded<\'FileUploadGeneration\'>;',
  },
  {
