...
export type CommandFileReceiptResolver =
  (agent: Agent, receiptId: string) => FileAttachmentRef | undefined | Promise<FileAttachmentRef | undefined>
...
async function admitCommandAttachments(
  ...
  resolveFileReceipt: (receiptId: string) => FileAttachmentRef | undefined | Promise<FileAttachmentRef | undefined>,
  ...
  for (const attachment of attachments) {
    ...
    const file = await resolveFileReceipt(attachment.receiptId)
    if (file === undefined) {
