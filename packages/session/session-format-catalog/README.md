...
Docker's optional `userId` header is validated and retained across header inspection, restoration, and encoding. This does not add historical readers for Docker-specific question or temporary-image records; retained database conversations follow the [deployment archive policy](../../../deploy/README.md#retained-data).
