...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/nacos/nacos-client': { kind: 'none', reason: 'The transport library reads and writes configuration without model registrations.' },
  'packages/nacos/credentials-nacos': { kind: 'indirect', reason: 'Credential consumers own authorized requests; this provider stores references and records.' },
  'packages/nacos/settings-nacos': { kind: 'indirect', reason: 'Settings consumers own model-visible effects; this provider stores namespace sections.' },
