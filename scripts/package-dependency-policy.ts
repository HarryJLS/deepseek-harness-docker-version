...
const PEER_REQUIRED_HOST_EXPORTS = {
  ...
  // Request ingress and persistence must share the same AsyncLocalStorage.
  '@deepseek-ai/dsh-user-context': [
    'DEFAULT_USER_ID', 'parseUserId',
    'requestUserId', 'currentUserId', 'withUser', 'canAccessUser', 'userScopedIterable',
  ],
  '@deepseek-ai/dsh-user-context/identity': ['parseUserId'],
} as const satisfies HostDependencyExports
