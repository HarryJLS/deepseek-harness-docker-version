...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionQuestionDecisionRequest: 'session.md',
  SessionQuestionDecisionValue: 'session.md',
  ...
  SharedFileUploadStore: 'attachment.md',
  SharedAssistantStateStore: 'session.md',
  ...
  UserQuestionId: 'user-questions.md',
  UserQuestionState: 'user-questions.md',
